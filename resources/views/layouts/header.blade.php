        ...
        <div class="collapse navbar-collapse mx-3" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ml-3">
                ...
                <li class="nav-item dropdown mx-2">
                    <a class="nav-link dropdown-toggle {{ (request()->segment(1) == 'about') ? 'active' : '' }}" href="#" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        About
                    </a>
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <li><a class="dropdown-item {{ (request()->segment(2) == 'aboutUs') ? 'active' : '' }}" href={{ url('/about/aboutUs') }}>About Us</a></li>
                        <li><a class="dropdown-item {{ (request()->segment(2) == 'contactUs') ? 'active' : '' }}" href={{ url('/about/contactUs') }}>Contact Us</a></li>
                        <li>
