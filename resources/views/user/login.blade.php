                        ...
                        <div class="col-lg-12 text-center mt-3">
                            <form action="/login" method="post">
                                ...
                                <div class="input-group px-0 py-2">
                                    ...
                                    <input type="email" class="form-control input-purple" name="txtEmail" id="txtEmail"
                                ...
                                <div class="input-group px-0 pt-2">
                                    ...
                                    <input type="password" class="form-control input-purple" name="txtPassword" id="txtPassword"
                                ...
                                <div class="col-lg-12 text-center mt-3">
                                    ...
                                    <button type="button" class="btn btn-purple m-1 px-3">Register</button>
                                </div>
                            </form>
                        </div>
                    </div>
